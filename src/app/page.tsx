...
const Home = async () => {
  ...
  return (
    <div className="h-screen w-full flex justify-center items-center bg-gray-400">
      ...
      <div className="w-[80%] flex rounded-tr-xl rounded-tl-xl p-5 bg-[#FAFAFA] h-[90%]">
        <div className="w-[20%] p-5  bg-[#F2F2F2]">
          <div className="flex justify-between">
            <h3 className="text-xl">Menu</h3>
            <BiMenu className="text-3xl text-[#7C7C7C]" />
          </div>
        </div>
        <div className="h-full w-[80%] bg-gray-500">
